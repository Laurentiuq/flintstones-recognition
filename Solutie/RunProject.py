...
params.overlap = 0.3
# params.number_positive_examples = 1665
...
params.threshold = 1.5 # toate ferestrele cu scorul > threshold si maxime locale devin detectii
...
print(f"In RunProject: {training_examples.shape} {train_labels.shape},,, {positive_features.shape} {negative_features.shape}")
